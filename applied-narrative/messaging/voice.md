...
- **Warmly Professional**: Friendly but not casual. We're colleagues, not buddies.
  - Example: "Let's get your team set up" not "Hey! Ready to crush some code reviews?!"
...
| Error Messages | Honest, actionable | "Analysis timed out. Your PR can still merge. We'll retry in background." |
...
- Assume reader context - be explicit
...
| Replace developers | Against core value | "Augment", "amplify", "assist" |

---

## Narrative Constraints
- All user-facing text must match tone for context
- Forbidden language triggers messaging drift warning
- New analogies require approval and addition here
